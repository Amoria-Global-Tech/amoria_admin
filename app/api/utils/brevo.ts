...
export async function sendOTPEmail(
  ...
  sendSmtpEmail.subject = isResend ? "New Verification Code - Amoria Login" : "Your Verification Code - Amoria Login";
  sendSmtpEmail.htmlContent = `
  <!DOCTYPE html>
  <html lang="en">
  <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Verification Code - Amoria</title>
  </head>
  <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%); min-height: 100vh;">
      <div style="max-width: 600px; margin: 40px auto; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 40px rgba(0, 0, 0, 0.15);">
          ...
          <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 40px 30px; text-align: center; position: relative; overflow: hidden;">
              ...
              <div style="background: rgba(255, 255, 255, 0.15); backdrop-filter: blur(10px); border-radius: 12px; padding: 25px; display: inline-block; position: relative; z-index: 1;">
                  <h1 style="color: #ffffff; margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -0.5px;">Amoria</h1>
                  <div style="width: 40px; height: 2px; background: rgba(255, 255, 255, 0.7); margin: 10px auto; border-radius: 1px;"></div>
                  <p style="color: rgba(255, 255, 255, 0.9); margin: 0; font-size: 14px; font-weight: 500; text-transform: uppercase; letter-spacing: 1px;">Secure Login</p>
              </div>
          </div>
          ...
          <div style="padding: 45px 35px;">
              ...
              <div style="background: linear-gradient(135deg, #f8fafc 0%, #ffffff 100%); border-radius: 12px; padding: 35px; margin-bottom: 35px; border: 1px solid #e2e8f0; position: relative; overflow: hidden;">
                  ...
                  <div style="position: relative; z-index: 1;">
                      <p style="color: #2d3748; font-size: 16px; line-height: 1.7; margin: 0 0 25px 0;">
                          ${isResend ? 'You requested a new verification code for your Amoria account.' : 'Welcome back! Please use the verification code below to complete your login.'}
                      </p>
                      
                      <!-- OTP Code Display -->
                      <div style="text-align: center; margin: 30px 0;">
                          <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 12px; padding: 20px; display: inline-block; box-shadow: 0 8px 25px rgba(102, 126, 234, 0.3);">
                              <p style="color: rgba(255, 255, 255, 0.8); font-size: 12px; margin: 0 0 8px 0; text-transform: uppercase; letter-spacing: 1px; font-weight: 500;">Your Verification Code</p>
                              <div style="color: #ffffff; font-size: 36px; font-weight: 700; font-family: 'Courier New', monospace; letter-spacing: 8px; margin: 0;">${otp}</div>
                          </div>
                      </div>
                      
                      <p style="color: #4a5568; font-size: 14px; margin: 0; text-align: center; line-height: 1.6;">
              ...
              <!-- Security Notice -->
              <div style="background: #fff5f5; border: 1px solid #fed7d7; border-radius: 12px; padding: 20px; margin-bottom: 30px;">
                  <div style="display: flex; align-items: flex-start;">
                      <div style="background: #e53e3e; border-radius: 50%; width: 20px; height: 20px; display: flex; align-items: center; justify-content: center; margin-right: 12px; flex-shrink: 0; margin-top: 2px;">
                          <div style="color: white; font-size: 12px; font-weight: bold;">!</div>
                      </div>
                      <div>
                          <h4 style="color: #742a2a; font-size: 14px; font-weight: 600; margin: 0 0 8px 0;">Security Notice</h4>
                          <p style="color: #742a2a; font-size: 13px; margin: 0; line-height: 1.5;">
                              Never share this code with anyone. Amoria will never ask for your verification code via phone or email.
                          </p>
                      </div>
                  </div>
              </div>
              ...
              <div style="border-top: 1px solid #e2e8f0; padding-top: 30px; text-align: left;">
                  <p style="color: #4a5568; font-size: 16px; margin: 0 0 5px 0; font-weight: 500;">Best regards,</p>
                  <p style="color: #2d3748; font-size: 18px; margin: 0 0 8px 0; font-weight: 600;">The Amoria Security Team</p>
                  <div style="display: flex; align-items: center; margin-top: 15px;">
                      <div style="width: 32px; height: 32px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 12px;">
                          <div style="width: 16px; height: 16px; background: rgba(255, 255, 255, 0.3); border-radius: 50%;"></div>
                      </div>
                      <div>
                          <p style="color: #4a5568; font-size: 12px; margin: 0; line-height: 1.2;">Secure Authentication System</p>
                          <p style="color: #667eea; font-size: 12px; margin: 0; font-weight: 500;">support@amoriaglobal.com</p>
                      </div>
                  </div>
              </div>
          ...
          <div style="background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%); padding: 30px; text-align: center; border-top: 1px solid #e2e8f0;">
              ...
              <p style="color: #718096; font-size: 13px; margin: 0 0 8px 0; line-height: 1.4;">
                  This verification code was requested for your Amoria account. If you didn't request this code, 
  ...
  sendSmtpEmail.sender = { "name": "Amoria Security", "email": "security@amoriaglobal.com"};
  sendSmtpEmail.to = [
    { "email": recipientEmail, "name": recipientName }
  ];
  sendSmtpEmail.headers = { 
    "X-Amoria-Type": "otp-verification",
    "X-Amoria-Recipient": recipientName,
    "X-Amoria-Action": isResend ? "resend-otp" : "send-otp"
  };
  sendSmtpEmail.params = { 
    "recipient_name": recipientName,
    "verification_code": otp,
    "is_resend": isResend.toString(),
    "expires_in": "10 minutes"
  };
  
  try {
    await apiInstance.sendTransacEmail(sendSmtpEmail);
    console.log(`${isResend ? 'Resent' : 'Sent'} OTP email successfully to:`, recipientEmail);
    return Promise.resolve();
  } catch (error) {
    console.error(`Failed to ${isResend ? 'resend' : 'send'} OTP email:`, error);
    return Promise.reject(error);
  }
}